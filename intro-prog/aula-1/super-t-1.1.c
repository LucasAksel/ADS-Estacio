...
int main(void)
{
    ...
    // EXIBIÇÃO DOS DADOS
    printf("Carta 1:\nCidade: %s\nEstado: %s\nCódigo: %s\nPopulação: %d\nÁrea: %.2f km²\nPIB: $%.2f\nPontos turísticos: %d\n\n",
           cidade1, estado1, codigo1, populacao1, area1, pib1, turismo1);

    printf("Carta 2:\nCidade: %s\nEstado: %s\nCódigo: %s\nPopulação: %d\nÁrea: %.2f km²\nPIB: $%.2f\nPontos turísticos: %d\n\n",
           cidade2, estado2, codigo2, populacao2, area2, pib2, turismo2);

    printf("Parabéns pela criação das cartas! Com isso nós encerramos o primeiro passo do nosso jogo.\n");
